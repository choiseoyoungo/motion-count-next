        ...
        {props.mode === 'count'
          ...
          : props.mode === 'countdown'
            ? props.countdownBurst
              ...
              : 'Countdown mode / 0-5'
            : `Flow mode / intensity ${intensity}`}{' '}
        / {props.modelReady ? 'Model loaded' : 'Model loading'} /{' '}
        {toTrackingLabel(props.trackingState)} /{' '}
        {toPermissionLabel(props.permissionState)} /{' '}
        {toStreamLabel(props.streamState)} / {props.videoResolution.width}x
        {props.videoResolution.height}
      </p>
    </section>
  )
}
